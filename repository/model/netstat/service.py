...
class ServiceImport:
    ...
    def set_cluster_id(self, val: str):
        """
        setter
...
class MultiClusterService:
    ...
    """ service export """
    def _get_export_index(self, val: ServiceExport) -> int:
        """
    ...
    @staticmethod
    def _validate_service_export(val: ServiceExport):
        """
        ...
        if type(val) != ServiceExport:
            raise TypeError('Invalid type for val({}). Must input val as ServiceExport'.format(type(val)))

    def set_service_export(self, val: ServiceExport):
        """
        set service export
        :param val: (ServiceExport)
        :return:
        ...
        if index < 0:
            self.exports.append(val)
        else:
            if self.exports[index]:
                temp = self.exports[index]
                self.exports[index] = val
                del temp
                # gc.collect()
            else:
                self.exports[index] = val

    def delete_service_export(self, val: ServiceExport):
        """
    ...
    def get_service_exports(self) -> List[ServiceExport]:
        """
        getter
    ...
    def set_service_exports(self, val: List[ServiceExport]):
        """
        set service exports
    ...
    """ service import """
    def _get_import_index(self, val: ServiceImport) -> int:
        """
    ...
    def set_service_import(self, val: ServiceImport):
        """
        set service import
        :param val: (ServiceImport)
        :return:
        ...
        if index < 0:
            ...
            if self.imports[index]:
                self.imports[index] = None
                self.imports[index] = val
            else:
                self.imports[index] = val

    @staticmethod
    def _validate_service_import(val: ServiceImport):
        """
        ...
        if type(val) != ServiceImport:
            raise TypeError('Invalid type for val({}). Must input val as ServiceImport'.format(type(val)))

    def delete_service_import(self, val: ServiceImport):
        """
    ...
    def get_service_imports(self) -> List[ServiceImport]:
        """
        getter
    ...
    def set_service_imports(self, val: List[ServiceImport]):
        """
        set service imports
    ...
    def synchronize_service_imports(self, val: ServiceImport):
        """
